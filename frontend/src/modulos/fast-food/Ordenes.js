...
const Ordenes = () => {
    ...
    const S = {
        ...
        pagination: {
            ...
            padding: '16px 20px', borderTop: '1px solid #f0f4f9',
    ...
    return (
        <div style={S.page}>
            <div style={S.wrap}>
                ...
                {/* Header */}
                <div style={S.header}>
                    <h1 style={S.title}>Gestión de Órdenes</h1>
                    <p style={S.subtitle}>Visualiza y administra todas las órdenes del sistema</p>
                </div>

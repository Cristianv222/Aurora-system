...
# Apps del servicio
INSTALLED_APPS.append('apps.consolidation')
INSTALLED_APPS.append('apps.analytics')
INSTALLED_APPS.append('apps.dashboards')
INSTALLED_APPS.append('apps.integrations')
INSTALLED_APPS.append('apps.exports')
...
ASGI_APPLICATION = 'reporting_service.asgi.application'
...
FAST_FOOD_SERVICE_URL = os.getenv('FAST_FOOD_SERVICE_URL', 'http://fast-food-service:8000')

# Generated by Django 5.0.1 on 2026-03-07 03:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('pos', 'Punto de Venta (POS)'), ('kitchen', 'Cocina'), ('both', 'Ambas funciones')], default='pos', help_text='pos = solo tickets de venta | kitchen = solo órdenes de cocina | both = ambas funciones', max_length=10, verbose_name='Rol de Impresora')),
            ...
            options={
                ...
                'ordering': ['name'],
                'indexes': [models.Index(fields=['is_active', 'is_default'], name='printer_pri_is_acti_de2fa0_idx'), models.Index(fields=['is_active', 'role'], name='printer_pri_is_acti_2cc5a8_idx')],
            },
        ),
        migrations.CreateModel(
            name='PrintJob',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('job_number', models.CharField(db_index=True, editable=False, max_length=35, unique=True, verbose_name='Número de Trabajo')),
